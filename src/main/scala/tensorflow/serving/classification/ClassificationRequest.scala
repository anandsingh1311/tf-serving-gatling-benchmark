...
/** @param modelSpec
  ...
  */
@SerialVersionUID(0L)
final case class ClassificationRequest(
    modelSpec: scala.Option[tensorflow.serving.model.ModelSpec] = None,
    input: scala.Option[tensorflow.serving.input.Input] = None
    ) extends scalapb.GeneratedMessage with scalapb.Message[ClassificationRequest] with scalapb.lenses.Updatable[ClassificationRequest] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): tensorflow.serving.classification.ClassificationRequest = {
    ...
    def clearModelSpec: ClassificationRequest = copy(modelSpec = None)
    def withModelSpec(__v: tensorflow.serving.model.ModelSpec): ClassificationRequest = copy(modelSpec = Option(__v))
    def getInput: tensorflow.serving.input.Input = input.getOrElse(tensorflow.serving.input.Input.defaultInstance)
    def clearInput: ClassificationRequest = copy(input = None)
    def withInput(__v: tensorflow.serving.input.Input): ClassificationRequest = copy(input = Option(__v))
    ...
    def companion = tensorflow.serving.classification.ClassificationRequest
}

object ClassificationRequest extends scalapb.GeneratedMessageCompanion[tensorflow.serving.classification.ClassificationRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[tensorflow.serving.classification.ClassificationRequest] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): tensorflow.serving.classification.ClassificationRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[tensorflow.serving.classification.ClassificationRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ClassificationProto.javaDescriptor.getMessageTypes.get(3)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ClassificationProto.scalaDescriptor.messages(3)
  ...
  lazy val defaultInstance = tensorflow.serving.classification.ClassificationRequest(
  )
  implicit class ClassificationRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, tensorflow.serving.classification.ClassificationRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, tensorflow.serving.classification.ClassificationRequest](_l) {
