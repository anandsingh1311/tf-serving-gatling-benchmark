...
final case class OpDeprecation(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.Message[OpDeprecation] with scalapb.lenses.Updatable[OpDeprecation] {
    @transient
    private[this] var __serializedSizeCachedValue: _root_.scala.Int = 0
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      var __size = 0
      if (version != 0) { __size += _root_.com.google.protobuf.CodedOutputStream.computeInt32Size(1, version) }
      if (explanation != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(2, explanation) }
      __size
    }
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.op_def.OpDeprecation = {
      var __version = this.version
      var __explanation = this.explanation
      var _done__ = false
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 18 =>
            __explanation = _input__.readString()
...
object OpDeprecation extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.op_def.OpDeprecation] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): org.tensorflow.framework.op_def.OpDeprecation = {
